...
public class ProtocolPacket {
    ...
    public final static String PACKET_BACKUP_SERVER_ADDRESS_NAME = "backupServerAddress";

    public final static String PACKET_STATUS_NAME = "status";
    public final static String PACKET_RESULT_NAME = "result";

    public final static String PACKET_NOTIFY_TYPE_NAME = "notifyType";
    public final static String PACKET_NOTIFY_ID_NAME = "notifyId";
    public final static String PACKET_NOTIFY_TITLE_NAME = "notifyTitle";
    public final static String PACKET_NOTIFY_CONTENT_NAME = "notifyContent";
    public final static String PACKET_NOTIFY_SENDER_NAME = "notifySender";
    public final static String PACKET_NOTIFY_RECEIVER_NAME = "notifyReceiver";
    ...
    public final static String PACKET_NETMODE_NAME = "netMode";
    ...
    public final static String PACKET_NAMETYPE_NAME = "nameType";
    ...
    public final static int DEV_CONFIG_REQ = 8;                     // call config
    ...
    public final static int NOTIFY_SEND_REQ = 18;
    public final static int NOTIFY_SEND_RES=118;

    public final static int SERVER_SUSPEND = 199;
    ...
    public static String GetTypeName(int type){
        ...
        switch(type){
            ...
            case CALL_CANCEL_RES:
                ...
                break;
            case SERVER_SUSPEND:
                packetTypeName = "Server_suspend";
                break;
            case NOTIFY_SEND_REQ:
                packetTypeName = "Notify_Send_Req";
                break;
            case NOTIFY_SEND_RES:
                packetTypeName = "Notify_Send_Res";
                break;
        }
